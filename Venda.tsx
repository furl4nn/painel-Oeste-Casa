...
export function Venda() {
  ...
  async function loadImoveis() {
    ...
    try {
      ...
      if (filters.aceita_permuta) query = query.eq('aceita_permuta', true);
      if (filters.aceita_financiamento) query = query.eq('aceita_financiamento', true);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#C8102E] to-[#A00D25] text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Imóveis à Venda</h1>
          <p className="text-gray-100">
            Encontre o imóvel perfeito para comprar
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          {showFilters && (
            <div className="border-t pt-6 mt-4 space-y-6">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-3">Preço (R$)</h3>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-3">Condições</h3>
                <div className="flex flex-wrap gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={filters.aceita_permuta}
                      onChange={(e) => setFilters({ ...filters, aceita_permuta: e.target.checked })}
                      className="w-4 h-4 text-[#C8102E] focus:ring-[#C8102E] rounded"
                    />
                    <span className="text-sm text-gray-700">Aceita Permuta</span>
                  </label>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setFilters({ ...filters, aceita_financiamento: e.target.checked })}
                      className="w-4 h-4 text-[#C8102E] focus:ring-[#C8102E] rounded"
                    />
